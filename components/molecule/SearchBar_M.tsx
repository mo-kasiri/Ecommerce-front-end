"use client";
import Button from "../atoms/Button_A";
...
const SearchBar = () => {
  ...
  return (
    <label className="input h-[58px] items-center gap-2 rounded-xl pl-[3px] bg-[#efe5d550] border-[#efe5d5ab] hidden lg:flex">
      ...
      <input
        type="text"
        className="grow text-[14px] text-[#3A3A3A] placeholder-[#3A3A3A] placeholder-opacity-50"
        placeholder="مدرن‌ترین ها را پیدا کنید..."
      />
      <Button handleClick={handleClick}>جستجو</Button>
    </label>
  );
};
